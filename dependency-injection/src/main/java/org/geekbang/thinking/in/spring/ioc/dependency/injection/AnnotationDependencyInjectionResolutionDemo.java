...
public class AnnotationDependencyInjectionResolutionDemo {
    ...
    //我们自定义的beanPostProcessor可以处理@Autowired + @Inject +  自定义的 @InjectedUser注解
    //这里我们继续用框架原来的 AutowiredAnnotationBeanPostProcessor,但增加了其可以处理的注解类型
    //以后标记@Autowired ,@Inject , 自定义的 @InjectedUser这三个注解是一样的效果
